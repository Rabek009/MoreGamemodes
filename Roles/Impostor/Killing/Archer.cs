...
namespace MoreGamemodes
{
    public class Archer : CustomRole
    {
        ...
        public override void OnPet()
        {
            ...
            if (target == null || (target.GetRole().IsImpostor() && !CanKillImpostors.GetBool()) || Vector2.Distance(Player.GetRealPosition(), target.transform.position) > ArrowDistance.GetFloat() * 7f) return;
