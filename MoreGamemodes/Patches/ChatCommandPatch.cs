                        ...
                        switch (subArgs)
                        {
                            ...
                            case "impostors":
                                ...
                                if (int.Parse(subArgs) < 1)
                                {
                                    ...
                                    DestroyableSingleton<HudManager>.Instance.Chat.AddChat(player, "Number of impostors is lower than 1. If you want to change other settings set impostors to more than 0!");
                                }
                                if (int.Parse(subArgs) > 3)
                                {
                                    ...
                                    GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, -1);
                                    GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, players);
                                    DestroyableSingleton<HudManager>.Instance.Chat.AddChat(player, "Number of impostors is greater than 3. If you want to change other settings set impostors to 3 or less!");
                                }
                            ...
                            case "players":
                                ...
                                if (int.Parse(subArgs) > 15)
                                {
                                    ...
                                    GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, -1);
                                    GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, players);
                                    DestroyableSingleton<HudManager>.Instance.Chat.AddChat(player, "Max players are greater than 15. If you want to change other settings set maximum players to 15 or lower!");
                                }
                            ...
                            case "playerspeed":
                                ...
                                if (float.Parse(subArgs) <= 0)
                                {
                                    ...
                                    GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, -1);
                                    GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, players);
                                    DestroyableSingleton<HudManager>.Instance.Chat.AddChat(player, "Player speed is lower or equals 0. If you want to change other settings set player speed to more than 0!");
                                }
                                if (float.Parse(subArgs) > 3)
                                {
                                    ...
                                    GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, -1);
                                    GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, players);
                                    DestroyableSingleton<HudManager>.Instance.Chat.AddChat(player, "Player speed is greater than 3. If you want to change other settings set player speed to 3 or less!");
                                }
                                ...
                                switch (subArgs)
                                {
                                    ...
                                    case "custom":
                                        ...
                                        if (int.Parse(subArgs) < 0)
                                        {
                                            ...
                                            GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, -1);
                                            GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, players);
                                            DestroyableSingleton<HudManager>.Instance.Chat.AddChat(player, "Kill distance is lower than 0. If you want to change other settings set kill distance to short, medium or long!");
                                        }
                                        if (int.Parse(subArgs) > 2)
                                        {
                                            ...
                                            GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, -1);
                                            GameOptionsManager.Instance.currentGameOptions.SetInt(Int32OptionNames.MaxPlayers, players);
                                            DestroyableSingleton<HudManager>.Instance.Chat.AddChat(player, "Kill distance is greater than 2. If you want to change other settings set kill distance to short, medium or long!");
                                        }
