...
namespace MoreGamemodes
{
    static class CustomRolesHelper
    {
        ...
        public static Dictionary<CustomRoles, string> RoleDescriptionsLong = new() 
        {
            ...
            {CustomRoles.Mortician, "Mortician (Crewmate): When you report dead body, you know target's role, killer's role and how old is body. During meeting you see death reasons."},
